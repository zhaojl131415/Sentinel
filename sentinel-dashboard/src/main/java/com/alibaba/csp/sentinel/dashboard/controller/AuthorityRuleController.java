...
public class AuthorityRuleController {
    ...
    /**
     * 从远程Nacos配置中心拉取授权规则
     * @see AuthorityRuleNacosProvider
     */
    @Autowired
    ...
    /**
     * 将授权规则推送到远程Nacos配置中心
     * @see AuthorityRuleNacosPublisher
     */
    @Autowired
...
//            List<AuthorityRuleEntity> rules = sentinelApiClient.fetchAuthorityRulesOfMachine(app, ip, port);
            ...
            /**
             * 从远程Nacos配置中心获取授权规则配置
             * @see AuthorityRuleNacosProvider#getRules(String)
             */
...
//    }
    ...
    private void publishRules(String app) {
        ...
        try {
            /**
             * 将授权规则推送到远程Nacos配置中心
             * @see AuthorityRuleNacosPublisher#publish(String, List)
             */
