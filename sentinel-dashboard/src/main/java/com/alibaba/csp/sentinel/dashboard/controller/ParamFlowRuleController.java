...
public class ParamFlowRuleController {
    ...
    /**
     * 从远程Nacos配置中心拉取热点参数规则
     * @see ParamFlowRuleNacosProvider
     */
    @Autowired
    ...
    /**
     * 将热点参数规则推送到远程Nacos配置中心
     * @see ParamFlowRuleNacosPublisher
     */
    @Autowired
...
//            List<ParamFlowRuleEntity> rules = sentinelApiClient.fetchParamFlowRulesOfMachine(app, ip, port).get();
            /**
             * 从远程Nacos配置中心获取 热点参数规则配置
             * @see ParamFlowRuleNacosProvider#getRules(String)
             */
...
//    }
    ...
    private void publishRules(String app) {
        ...
        try {
            /**
             * 将热点参数规则推送到远程Nacos配置中心
             * @see ParamFlowRuleNacosPublisher#publish(String, List)
             */
